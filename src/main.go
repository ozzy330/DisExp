...
func main() {
	...
	fmt.Printf("QOI, %d, %d", qoiSize, sizePNG.Size())
	...
	fmt.Printf("QOI Run, %d, %d", qoiSize, sizePNG.Size())
	...
	fmt.Printf("QOI Diff/Luma, %d, %d", qoiSize, sizePNG.Size())
}
